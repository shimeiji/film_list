...
limit = 2
rootDir = "C:\\Users\lomax\OneDrive\Documentos\Pokerstars"
game_count = 0
global_win_count = 0
global_hand_count = 0
	...
	for fileToOpen in files:	
		...
		for text_block in form_text:
			...
			for line in next_text:
				if "Dealt to bittebitter" in line:
					total_hands += 1
					my_hand = line[-7:]
					card1 = my_hand[1]; card2 = my_hand[4]
					card1_suit = my_hand[2]; card2_suit = my_hand[5]
				...
				if "bittebitter collected" in line:
